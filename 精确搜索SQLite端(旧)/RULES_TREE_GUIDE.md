...
**位置**: [script.js:435-480](script.js#L435-L480)
...
**位置**: [script.js:1461-1521](script.js#L1461-L1521)
...
**位置**: [script.js:2448-2537](script.js#L2448-L2537)
...
**位置**: [app.py:224-287](app.py#L224-L287)
...
**位置**: [script.js:490-593](script.js#L490-L593)
...
### Q4: 删除组后数据库仍有记录?
**说明**: 这是**软删除**设计,`is_enabled = 0`
**好处**: 可恢复,不破坏外键关系
**清理**: 需手动在数据库执行 `DELETE` (谨慎!)
...
| 函数 | 行号 | 功能 |
|------|------|------|
| `buildTree()` | 362-427 | 扁平数据组装成树 |
| `expandKeywords()` | 435-480 | 关键词膨胀算法 |
| `handleSave()` | 490-593 | 乐观锁写入 + 冲突处理 |
| `renderRulesTree()` | 1213-1370 | 渲染侧边栏UI |
| `handleHierarchyChange()` | 1461-1521 | 拖拽层级管理 |
| `deleteGroup()` | 2448-2537 | 递归删除组 |
| `loadRulesTree()` | 1761-1832 | 加载规则树 |

### 后端 (app.py)

| 函数 | 行号 | 功能 |
|------|------|------|
| `get_rules_data()` | 107-121 | 读取规则树 |
| `try_write()` | 224-287 | 乐观锁事务 |
| `has_hierarchy_cycle()` | 145-188 | 循环检测 |
| `add_hierarchy()` | 191-207 | 添加层级关系 |
